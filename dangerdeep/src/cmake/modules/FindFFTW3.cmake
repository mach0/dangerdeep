...
if (WIN32)
    ...
    foreach(_lib ${_libraries})
      ...
      find_library(${_LIB}_LIBRARY lib${_lib}-3
        HINTS $ENV{FFTW3_ROOT_DIR} PATH_SUFFIXES lib PATHS "${PROJECT_SOURCE_DIR}/build/win64/fftw/" )	# for win32 PATHS is defined
...
find_path(FFTW3_INCLUDE_DIR fftw3.h 
  HINTS $ENV{FFTW3_ROOT_DIR} PATH_SUFFIXES include PATHS "${PROJECT_SOURCE_DIR}/build/win64/fftw/" )	# for win32 PATHS is defined
