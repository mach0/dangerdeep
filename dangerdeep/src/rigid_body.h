...
class rigid_body
{
  public:
    ...
    momentum3d angular_momentum; // angular momentum ("L") L = I * w = R * I_k *
    ...
    angular_velocity turn_velocity;  // angular velocity around local z-axis
                                     // (mathematical CCW)
    angular_velocity pitch_velocity; // angular velocity around local x-axis
                                     // (mathematical CCW)
    angular_velocity roll_velocity;  // angular velocity around local y-axis
                                     // (mathematical CCW)
