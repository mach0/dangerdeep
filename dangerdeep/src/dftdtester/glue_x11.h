...
GLXContext (*DFTD_glXCreateContext)(
    Display* dpy, XVisualInfo* vis, GLXContext shareList, Bool direct);
#define glXCreateContext(a, b, c, d) \
    (*DFTD_glXCreateContext)((a), (b), (c), (d))
...
#define XCreateWindow(a, b, c, d, e, f, g, h, i, j, k, l) \
    (*DFTD_XCreateWindow)(                                \
        (a), (b), (c), (d), (e), (f), (g), (h), (i), (j), (k), (l))
Colormap (*DFTD_XCreateColormap)(
