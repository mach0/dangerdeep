...
class water_splash : public sea_object
{
  ...
  public:
    ...
    {
    } // static object, no acceleration
    static auto torpedo(game& gm, const vector3& pos)
    {
        return water_splash(gm, pos, 0.4, 20.0);
    }
    static auto depth_charge(game& gm, const vector3& pos)
    {
        return water_splash(gm, pos, 0.6, 30.0);
    }
    static auto gun_shell(game& gm, const vector3& pos)
    {
