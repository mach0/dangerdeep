...
class perlinnoise
{
  ...
  public:
    // give size of result (power of two), size of noise function with minimal
    // frequency and maximum frequency sizeminfreq is usually very small, 2 or 4
    // at least, at most the same as size, at least 2 sizemaxfreq is usually
    // very high, at most the same as size, at least as sizeminfreq
