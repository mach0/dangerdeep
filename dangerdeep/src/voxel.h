...
public:
	...
	/// indices of neighbouring voxels: top, left, forward, right, backward, bottom, -1 means no neighbour
...
public:
	...
	std::vector<voxel> voxels;	///< per voxel: relative 3d position and part of volume that is inside (0...1)
	std::vector<int> voxel_index_by_pos;	///< voxel for 3-space coordinate of it, -1 if not existing
