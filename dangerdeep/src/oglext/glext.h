...
#define glTexSubImage3D             OGLEXT_MAKEGLNAME(TexSubImage3D)
    ...
    GLAPI GLvoid
    glColorSubTable(GLenum, GLsizei, GLsizei, GLenum, GLenum, GLvoid const*);
    GLAPI GLvoid
    glColorTable(GLenum, GLenum, GLsizei, GLenum, GLenum, GLvoid const*);
...
#define glMultiDrawRangeElementArrayAPPLE \
    ...
    GLAPI GLvoid
        glDrawRangeElementArrayAPPLE(GLenum, GLuint, GLuint, GLint, GLsizei);
...
#define glMultiTexCoord4svARB    OGLEXT_MAKEGLNAME(MultiTexCoord4svARB)
    ...
    GLAPI GLvoid
        glMultiTexCoord4dARB(GLenum, GLdouble, GLdouble, GLdouble, GLdouble);
    GLAPI GLvoid glMultiTexCoord4dvARB(GLenum, GLdouble const*);
    GLAPI
    GLvoid glMultiTexCoord4fARB(GLenum, GLfloat, GLfloat, GLfloat, GLfloat);
    ...
    GLAPI
    GLvoid glMultiTexCoord4sARB(GLenum, GLshort, GLshort, GLshort, GLshort);
...
#define glValidateProgramARB      OGLEXT_MAKEGLNAME(ValidateProgramARB)
    ...
    GLAPI GLvoid
    glGetShaderSourceARB(GLhandleARB, GLsizei, GLsizei*, GLcharARB*);
    ...
    GLAPI GLvoid
    glShaderSourceARB(GLhandleARB, GLsizei, GLcharARB const**, GLint const*);
    ...
    GLAPI GLvoid
    glUniformMatrix2fvARB(GLint, GLsizei, GLboolean, GLfloat const*);
    GLAPI GLvoid
    glUniformMatrix3fvARB(GLint, GLsizei, GLboolean, GLfloat const*);
    GLAPI GLvoid
    glUniformMatrix4fvARB(GLint, GLsizei, GLboolean, GLfloat const*);
...
#define glUnmapBufferARB          OGLEXT_MAKEGLNAME(UnmapBufferARB)
    ...
    GLAPI GLvoid
    glBufferSubDataARB(GLenum, GLintptrARB, GLsizeiptrARB, GLvoid const*);
...
#define glVariantArrayObjectATI OGLEXT_MAKEGLNAME(VariantArrayObjectATI)
    ...
    GLAPI
    GLvoid glArrayObjectATI(GLenum, GLint, GLenum, GLsizei, GLuint, GLuint);
    ...
    GLAPI GLvoid
    glUpdateObjectBufferATI(GLuint, GLuint, GLsizei, GLvoid const*, GLenum);
    GLAPI
    GLvoid glVariantArrayObjectATI(GLuint, GLenum, GLsizei, GLuint, GLuint);
...
#define glVertexStream4svATI OGLEXT_MAKEGLNAME(VertexStream4svATI)
    ...
    GLAPI GLvoid
        glVertexStream4dATI(GLenum, GLdouble, GLdouble, GLdouble, GLdouble);
    GLAPI GLvoid glVertexStream4dvATI(GLenum, GLdouble const*);
    GLAPI
    GLvoid glVertexStream4fATI(GLenum, GLfloat, GLfloat, GLfloat, GLfloat);
    ...
    GLAPI
    GLvoid glVertexStream4sATI(GLenum, GLshort, GLshort, GLshort, GLshort);
...
#define glCopyColorSubTableEXT OGLEXT_MAKEGLNAME(CopyColorSubTableEXT)
    ...
    GLAPI GLvoid
    glColorSubTableEXT(GLenum, GLsizei, GLsizei, GLenum, GLenum, GLvoid const*);
...
#define glRenderbufferStorageEXT OGLEXT_MAKEGLNAME(RenderbufferStorageEXT)
    ...
    GLAPI GLvoid
        glFramebufferTexture3DEXT(GLenum, GLenum, GLenum, GLuint, GLint, GLint);
    ...
    GLAPI GLvoid
    glGetFramebufferAttachmentParameterivEXT(GLenum, GLenum, GLenum, GLint*);
...
#define glGetColorTableParameterivEXT \
    ...
    glColorSubTableEXT(GLenum, GLsizei, GLsizei, GLenum, GLenum, GLvoid const*);
    GLAPI GLvoid
    glColorTableEXT(GLenum, GLenum, GLsizei, GLenum, GLenum, GLvoid const*);
...
#define glSecondaryColorPointerEXT OGLEXT_MAKEGLNAME(SecondaryColorPointerEXT)
    ...
    GLAPI GLvoid
    glSecondaryColorPointerEXT(GLint, GLenum, GLsizei, GLvoid const*);
...
#define glPrioritizeTexturesEXT  OGLEXT_MAKEGLNAME(PrioritizeTexturesEXT)
    ...
    GLAPI GLboolean
    glAreTexturesResidentEXT(GLsizei, GLuint const*, GLboolean*);
    ...
    GLAPI GLvoid
    glPrioritizeTexturesEXT(GLsizei, GLuint const*, GLclampf const*);
...
#define glVertexPointerEXT   OGLEXT_MAKEGLNAME(VertexPointerEXT)
    ...
    GLAPI GLvoid
    glColorPointerEXT(GLint, GLenum, GLsizei, GLsizei, GLvoid const*);
    ...
    GLAPI GLvoid
    glTexCoordPointerEXT(GLint, GLenum, GLsizei, GLsizei, GLvoid const*);
    GLAPI GLvoid
    glVertexPointerEXT(GLint, GLenum, GLsizei, GLsizei, GLvoid const*);
...
#define glVertexWeightPointerEXT OGLEXT_MAKEGLNAME(VertexWeightPointerEXT)
    ...
    GLAPI GLvoid
    glVertexWeightPointerEXT(GLsizei, GLenum, GLsizei, GLvoid const*);
...
#define glVertexPointerListIBM   OGLEXT_MAKEGLNAME(VertexPointerListIBM)
    ...
    GLAPI GLvoid
    glColorPointerListIBM(GLint, GLenum, GLint, GLvoid const**, GLint);
    ...
    GLAPI GLvoid
    glSecondaryColorPointerListIBM(GLint, GLenum, GLint, GLvoid const**, GLint);
    GLAPI GLvoid
    glTexCoordPointerListIBM(GLint, GLenum, GLint, GLvoid const**, GLint);
    GLAPI GLvoid
    glVertexPointerListIBM(GLint, GLenum, GLint, GLvoid const**, GLint);
...
#define glMultiDrawRangeElementArrayNV \
    ...
    GLAPI GLvoid
        glDrawRangeElementArrayNV(GLenum, GLuint, GLuint, GLint, GLsizei);
...
#define glProgramNamedParameter4fvNV \
    ...
    GLAPI GLvoid
    glGetProgramNamedParameterdvNV(GLuint, GLsizei, GLubyte const*, GLdouble*);
    GLAPI GLvoid
...
#define glVertexWeighthvNV    OGLEXT_MAKEGLNAME(VertexWeighthvNV)
    ...
    GLAPI GLvoid
        glMultiTexCoord4hNV(GLenum, GLhalfNV, GLhalfNV, GLhalfNV, GLhalfNV);
    ...
    GLAPI GLvoid
        glVertexAttrib4hNV(GLuint, GLhalfNV, GLhalfNV, GLhalfNV, GLhalfNV);
...
#define glGetFinalCombinerInputParameterivNV \
    ...
    GLAPI GLvoid
    glGetCombinerInputParameterfvNV(GLenum, GLenum, GLenum, GLenum, GLfloat*);
    GLAPI GLvoid
    glGetCombinerInputParameterivNV(GLenum, GLenum, GLenum, GLenum, GLint*);
    GLAPI GLvoid
    glGetCombinerOutputParameterfvNV(GLenum, GLenum, GLenum, GLfloat*);
    GLAPI GLvoid
    glGetCombinerOutputParameterivNV(GLenum, GLenum, GLenum, GLint*);
...
#define glVertexAttribs4ubvNV       OGLEXT_MAKEGLNAME(VertexAttribs4ubvNV)
    ...
    GLAPI GLvoid
    glProgramParameters4fvNV(GLenum, GLuint, GLuint, GLfloat const*);
    ...
    GLAPI GLvoid
    glVertexAttribPointerNV(GLuint, GLint, GLenum, GLsizei, GLvoid const*);
...
#define glGetColorTableSGI OGLEXT_MAKEGLNAME(GetColorTableSGI)
    ...
    GLAPI GLvoid
    glColorTableSGI(GLenum, GLenum, GLsizei, GLenum, GLenum, GLvoid const*);
...
#define glTextureColorMaskSGIS OGLEXT_MAKEGLNAME(TextureColorMaskSGIS)
    ...
    GLAPI GLvoid
        glTextureColorMaskSGIS(GLboolean, GLboolean, GLboolean, GLboolean);
