// OglExt.cpp                                                Copyright (C) 2006
// thomas jansen (jansen@caesar.de)
//                                                                     (C) 2006
//                                                                     research
//                                                                     center
//                                                                     caesar
...
GLvoid WRAPPER04V(BlendColor, GLclampf, GLclampf, GLclampf, GLclampf) GLvoid
    ...
    WRAPPER03V(ConvolutionParameteri, GLenum, GLenum, GLint) GLvoid
    WRAPPER03V(ConvolutionParameteriv, GLenum, GLenum, GLint const*) GLvoid
    WRAPPER05V(CopyColorSubTable, GLenum, GLsizei, GLint, GLint, GLsizei) GLvoid
    ...
    WRAPPER03V(GetColorTableParameteriv, GLenum, GLenum, GLint*) GLvoid
    WRAPPER04V(GetConvolutionFilter, GLenum, GLenum, GLenum, GLvoid*) GLvoid
    WRAPPER03V(GetConvolutionParameterfv, GLenum, GLenum, GLfloat*) GLvoid
    WRAPPER03V(GetConvolutionParameteriv, GLenum, GLenum, GLint*) GLvoid
    WRAPPER05V(GetHistogram, GLenum, GLboolean, GLenum, GLenum, GLvoid*) GLvoid
    WRAPPER03V(GetHistogramParameterfv, GLenum, GLenum, GLfloat*) GLvoid
    WRAPPER03V(GetHistogramParameteriv, GLenum, GLenum, GLint*) GLvoid
...
// ]----------------------------------------------------------------------------------------
    ...
    WRAPPER02V(MultiTexCoord1d, GLenum, GLdouble) GLvoid
    WRAPPER02V(MultiTexCoord1dv, GLenum, GLdouble const*) GLvoid
    WRAPPER02V(MultiTexCoord1f, GLenum, GLfloat) GLvoid
    WRAPPER02V(MultiTexCoord1fv, GLenum, GLfloat const*) GLvoid
    WRAPPER02V(MultiTexCoord1i, GLenum, GLint) GLvoid
    WRAPPER02V(MultiTexCoord1iv, GLenum, GLint const*) GLvoid
    WRAPPER02V(MultiTexCoord1s, GLenum, GLshort) GLvoid
    WRAPPER02V(MultiTexCoord1sv, GLenum, GLshort const*) GLvoid
    WRAPPER03V(MultiTexCoord2d, GLenum, GLdouble, GLdouble) GLvoid
    WRAPPER02V(MultiTexCoord2dv, GLenum, GLdouble const*) GLvoid
    WRAPPER03V(MultiTexCoord2f, GLenum, GLfloat, GLfloat) GLvoid
    WRAPPER02V(MultiTexCoord2fv, GLenum, GLfloat const*) GLvoid
    WRAPPER03V(MultiTexCoord2i, GLenum, GLint, GLint) GLvoid
    WRAPPER02V(MultiTexCoord2iv, GLenum, GLint const*) GLvoid
    WRAPPER03V(MultiTexCoord2s, GLenum, GLshort, GLshort) GLvoid
    WRAPPER02V(MultiTexCoord2sv, GLenum, GLshort const*) GLvoid
    WRAPPER04V(MultiTexCoord3d, GLenum, GLdouble, GLdouble, GLdouble) GLvoid
    WRAPPER02V(MultiTexCoord3dv, GLenum, GLdouble const*) GLvoid
    WRAPPER04V(MultiTexCoord3f, GLenum, GLfloat, GLfloat, GLfloat) GLvoid
    WRAPPER02V(MultiTexCoord3fv, GLenum, GLfloat const*) GLvoid
...
// ]----------------------------------------------------------------------------------------
        ...
        GLvoid
    WRAPPER04V(BlendFuncSeparate, GLenum, GLenum, GLenum, GLenum) GLvoid
    WRAPPER01V(FogCoordd, GLdouble) GLvoid
    WRAPPER01V(FogCoorddv, GLdouble const*) GLvoid
    WRAPPER01V(FogCoordf, GLfloat) GLvoid
    WRAPPER01V(FogCoordfv, GLfloat const*) GLvoid
    ...
    WRAPPER02V(PointParameteriv, GLenum, GLint const*) GLvoid
    WRAPPER03V(SecondaryColor3b, GLbyte, GLbyte, GLbyte) GLvoid
    WRAPPER01V(SecondaryColor3bv, GLbyte const*) GLvoid
    WRAPPER03V(SecondaryColor3d, GLdouble, GLdouble, GLdouble) GLvoid
    WRAPPER01V(SecondaryColor3dv, GLdouble const*) GLvoid
    WRAPPER03V(SecondaryColor3f, GLfloat, GLfloat, GLfloat) GLvoid
    WRAPPER01V(SecondaryColor3fv, GLfloat const*) GLvoid
    WRAPPER03V(SecondaryColor3i, GLint, GLint, GLint) GLvoid
    WRAPPER01V(SecondaryColor3iv, GLint const*) GLvoid
    WRAPPER03V(SecondaryColor3s, GLshort, GLshort, GLshort) GLvoid
    WRAPPER01V(SecondaryColor3sv, GLshort const*) GLvoid
    WRAPPER03V(SecondaryColor3ub, GLubyte, GLubyte, GLubyte) GLvoid
    WRAPPER01V(SecondaryColor3ubv, GLubyte const*) GLvoid
    ...
    WRAPPER02V(WindowPos2i, GLint, GLint) GLvoid
    WRAPPER01V(WindowPos2iv, GLint const*) GLvoid
    WRAPPER02V(WindowPos2s, GLshort, GLshort) GLvoid
    WRAPPER01V(WindowPos2sv, GLshort const*) GLvoid
    WRAPPER03V(WindowPos3d, GLdouble, GLdouble, GLdouble) GLvoid
    WRAPPER01V(WindowPos3dv, GLdouble const*) GLvoid
    WRAPPER03V(WindowPos3f, GLfloat, GLfloat, GLfloat) GLvoid
    WRAPPER01V(WindowPos3fv, GLfloat const*) GLvoid
    WRAPPER03V(WindowPos3i, GLint, GLint, GLint) GLvoid
    WRAPPER01V(WindowPos3iv, GLint const*) GLvoid
    WRAPPER03V(WindowPos3s, GLshort, GLshort, GLshort) GLvoid
    WRAPPER01V(WindowPos3sv, GLshort const*)
...
// ]----------------------------------------------------------------------------------------
        ...
        GLvoid WRAPPER02V(BeginQuery, GLenum, GLuint) GLvoid
    WRAPPER02V(BindBuffer, GLenum, GLuint) GLvoid
    WRAPPER04V(BufferData, GLenum, GLsizeiptr, GLvoid const*, GLenum) GLvoid
    WRAPPER04V(BufferSubData, GLenum, GLintptr, GLsizeiptr, GLvoid const*)
        GLvoid WRAPPER02V(DeleteBuffers, GLsizei, GLuint const*) GLvoid
    WRAPPER02V(DeleteQueries, GLsizei, GLuint const*) GLvoid
    WRAPPER01V(EndQuery, GLenum) GLvoid
    WRAPPER02V(GenBuffers, GLsizei, GLuint*) GLvoid
    WRAPPER02V(GenQueries, GLsizei, GLuint*) GLvoid
    WRAPPER03V(GetBufferParameteriv, GLenum, GLenum, GLint*) GLvoid
    WRAPPER03V(GetBufferPointerv, GLenum, GLenum, GLvoid**) GLvoid
    WRAPPER04V(GetBufferSubData, GLenum, GLintptr, GLsizeiptr, GLvoid*) GLvoid
...
// ]----------------------------------------------------------------------------------------
        ...
        GLvoid WRAPPER02V(AttachShader, GLuint, GLuint) GLvoid
    WRAPPER03V(BindAttribLocation, GLuint, GLuint, GLchar const*) GLvoid
    WRAPPER02V(BlendEquationSeparate, GLenum, GLenum) GLvoid
    WRAPPER01V(CompileShader, GLuint) GLuint WRAPPER00R(CreateProgram) GLuint
    WRAPPER01R(CreateShader, GLenum) GLvoid
    WRAPPER01V(DeleteProgram, GLuint) GLvoid
    WRAPPER01V(DeleteShader, GLuint) GLvoid
    WRAPPER02V(DetachShader, GLuint, GLuint) GLvoid
    ...
    WRAPPER04V(GetProgramInfoLog, GLuint, GLsizei, GLsizei*, GLchar*) GLvoid
    WRAPPER03V(GetProgramiv, GLuint, GLenum, GLint*) GLvoid
    WRAPPER04V(GetShaderInfoLog, GLuint, GLsizei, GLsizei*, GLchar*) GLvoid
    WRAPPER03V(GetShaderiv, GLuint, GLenum, GLint*) GLvoid
    WRAPPER04V(GetShaderSource, GLuint, GLsizei, GLsizei*, GLchar*) GLvoid
    WRAPPER03V(GetUniformfv, GLuint, GLint, GLfloat*) GLvoid
    WRAPPER03V(GetUniformiv, GLuint, GLint, GLint*) GLint
    WRAPPER02R(GetUniformLocation, GLuint, GLchar const*) GLvoid
    WRAPPER03V(GetVertexAttribdv, GLuint, GLenum, GLdouble*) GLvoid
    WRAPPER03V(GetVertexAttribfv, GLuint, GLenum, GLfloat*) GLvoid
    ...
    WRAPPER02V(Uniform1f, GLint, GLfloat) GLvoid
    WRAPPER03V(Uniform1fv, GLint, GLsizei, GLfloat const*) GLvoid
    WRAPPER02V(Uniform1i, GLint, GLint) GLvoid
    WRAPPER03V(Uniform1iv, GLint, GLsizei, GLint const*) GLvoid
    WRAPPER03V(Uniform2f, GLint, GLfloat, GLfloat) GLvoid
    WRAPPER03V(Uniform2fv, GLint, GLsizei, GLfloat const*) GLvoid
    WRAPPER03V(Uniform2i, GLint, GLint, GLint) GLvoid
    WRAPPER03V(Uniform2iv, GLint, GLsizei, GLint const*) GLvoid
    WRAPPER04V(Uniform3f, GLint, GLfloat, GLfloat, GLfloat) GLvoid
    WRAPPER03V(Uniform3fv, GLint, GLsizei, GLfloat const*) GLvoid
    WRAPPER04V(Uniform3i, GLint, GLint, GLint, GLint) GLvoid
    WRAPPER03V(Uniform3iv, GLint, GLsizei, GLint const*) GLvoid
    ...
    WRAPPER02V(VertexAttrib1f, GLuint, GLfloat) GLvoid
    WRAPPER02V(VertexAttrib1fv, GLuint, GLfloat const*) GLvoid
    WRAPPER02V(VertexAttrib1s, GLuint, GLshort) GLvoid
    WRAPPER02V(VertexAttrib1sv, GLuint, GLshort const*) GLvoid
    WRAPPER03V(VertexAttrib2d, GLuint, GLdouble, GLdouble) GLvoid
    WRAPPER02V(VertexAttrib2dv, GLuint, GLdouble const*) GLvoid
    WRAPPER03V(VertexAttrib2f, GLuint, GLfloat, GLfloat) GLvoid
    WRAPPER02V(VertexAttrib2fv, GLuint, GLfloat const*) GLvoid
    WRAPPER03V(VertexAttrib2s, GLuint, GLshort, GLshort) GLvoid
    WRAPPER02V(VertexAttrib2sv, GLuint, GLshort const*) GLvoid
    WRAPPER04V(VertexAttrib3d, GLuint, GLdouble, GLdouble, GLdouble) GLvoid
    WRAPPER02V(VertexAttrib3dv, GLuint, GLdouble const*) GLvoid
    WRAPPER04V(VertexAttrib3f, GLuint, GLfloat, GLfloat, GLfloat) GLvoid
...
// ]----------------------------------------------------------------------------------------
        ...
        GLvoid WRAPPER02V(DeleteFencesAPPLE, GLsizei, GLuint const*) GLvoid
    WRAPPER01V(FinishFenceAPPLE, GLuint) GLvoid
    WRAPPER02V(FinishObjectAPPLE, GLenum, GLint) GLvoid
    WRAPPER02V(GenFencesAPPLE, GLsizei, GLuint*) GLboolean
    WRAPPER01R(IsFenceAPPLE, GLuint) GLvoid
    WRAPPER01V(SetFenceAPPLE, GLuint) GLboolean
    WRAPPER01R(TestFenceAPPLE, GLuint) GLboolean
    WRAPPER02R(TestObjectAPPLE, GLenum, GLuint)
...
// ]--------------------------------------------------------------------------
        ...
        GLvoid WRAPPER01V(BindVertexArrayAPPLE, GLuint) GLvoid
    WRAPPER02V(DeleteVertexArraysAPPLE, GLsizei, GLuint const*) GLvoid
    WRAPPER02V(GenVertexArraysAPPLE, GLsizei, GLuint const*) GLboolean
    WRAPPER01R(IsVertexArrayAPPLE, GLuint)
...
// ]---------------------------------------------------------------------------
        ...
        GLvoid WRAPPER02V(FlushVertexArrayRangeAPPLE, GLsizei, GLvoid*) GLvoid
    WRAPPER02V(VertexArrayParameteriAPPLE, GLenum, GLint) GLvoid
    WRAPPER02V(VertexArrayRangeAPPLE, GLsizei, GLvoid*)
...
// ]---------------------------------------------------------------------------------
                ...
                GLvoid WRAPPER01V(CurrentPaletteMatrixARB, GLint) GLvoid
    WRAPPER04V(MatrixIndexPointerARB, GLint, GLenum, GLsizei, GLvoid const*)
        GLvoid WRAPPER02V(MatrixIndexubvARB, GLint, GLubyte const*) GLvoid
    WRAPPER02V(MatrixIndexuivARB, GLint, GLuint const*) GLvoid
    WRAPPER02V(MatrixIndexusvARB, GLint, GLushort const*)
...
// ]-----------------------------------------------------------------------------------
            ...
            GLvoid WRAPPER01V(ActiveTextureARB, GLenum) GLvoid
    WRAPPER01V(ClientActiveTextureARB, GLenum) GLvoid
    WRAPPER02V(MultiTexCoord1dARB, GLenum, GLdouble) GLvoid
    WRAPPER02V(MultiTexCoord1dvARB, GLenum, GLdouble const*) GLvoid
    WRAPPER02V(MultiTexCoord1fARB, GLenum, GLfloat) GLvoid
    WRAPPER02V(MultiTexCoord1fvARB, GLenum, GLfloat const*) GLvoid
    WRAPPER02V(MultiTexCoord1iARB, GLenum, GLint) GLvoid
    WRAPPER02V(MultiTexCoord1ivARB, GLenum, GLint const*) GLvoid
    WRAPPER02V(MultiTexCoord1sARB, GLenum, GLshort) GLvoid
    WRAPPER02V(MultiTexCoord1svARB, GLenum, GLshort const*) GLvoid
    WRAPPER03V(MultiTexCoord2dARB, GLenum, GLdouble, GLdouble) GLvoid
    WRAPPER02V(MultiTexCoord2dvARB, GLenum, GLdouble const*) GLvoid
    WRAPPER03V(MultiTexCoord2fARB, GLenum, GLfloat, GLfloat) GLvoid
    WRAPPER02V(MultiTexCoord2fvARB, GLenum, GLfloat const*) GLvoid
    WRAPPER03V(MultiTexCoord2iARB, GLenum, GLint, GLint) GLvoid
    WRAPPER02V(MultiTexCoord2ivARB, GLenum, GLint const*) GLvoid
    WRAPPER03V(MultiTexCoord2sARB, GLenum, GLshort, GLshort) GLvoid
    WRAPPER02V(MultiTexCoord2svARB, GLenum, GLshort const*) GLvoid
    WRAPPER04V(MultiTexCoord3dARB, GLenum, GLdouble, GLdouble, GLdouble) GLvoid
    WRAPPER02V(MultiTexCoord3dvARB, GLenum, GLdouble const*) GLvoid
    WRAPPER04V(MultiTexCoord3fARB, GLenum, GLfloat, GLfloat, GLfloat) GLvoid
    WRAPPER02V(MultiTexCoord3fvARB, GLenum, GLfloat const*) GLvoid
    WRAPPER04V(MultiTexCoord3iARB, GLenum, GLint, GLint, GLint) GLvoid
...
// ]--------------------------------------------------------------------------------
    ...
    WRAPPER03V(GetQueryivARB, GLenum, GLenum, GLint*) GLvoid
    WRAPPER03V(GetQueryObjectivARB, GLuint, GLenum, GLint*) GLvoid
    WRAPPER03V(GetQueryObjectuivARB, GLuint, GLenum, GLuint*) GLboolean
    WRAPPER01R(IsQueryARB, GLuint)
...
// ]-------------------------------------------------------------------------------
        ...
        GLvoid WRAPPER02V(PointParameterfARB, GLenum, GLfloat) GLvoid
    WRAPPER02V(PointParameterfvARB, GLenum, GLfloat const*)
...
// ]---------------------------------------------------------------------------------
        ...
        GLvoid WRAPPER02V(AttachObjectARB, GLhandleARB, GLhandleARB) GLvoid
    WRAPPER01V(CompileShaderARB, GLhandleARB) GLhandleARB
    WRAPPER00R(CreateProgramObjectARB) GLhandleARB
    ...
    WRAPPER03V(GetObjectParameterivARB, GLhandleARB, GLenum, GLint*) GLvoid
    WRAPPER04V(GetShaderSourceARB, GLhandleARB, GLsizei, GLsizei*, GLcharARB*)
        GLvoid WRAPPER03V(GetUniformfvARB, GLhandleARB, GLint, GLfloat*) GLvoid
    ...
    WRAPPER03V(Uniform1ivARB, GLint, GLsizei, GLint const*) GLvoid
    WRAPPER03V(Uniform2fARB, GLint, GLfloat, GLfloat) GLvoid
    WRAPPER03V(Uniform2fvARB, GLint, GLsizei, GLfloat const*) GLvoid
    WRAPPER03V(Uniform2iARB, GLint, GLint, GLint) GLvoid
    WRAPPER03V(Uniform2ivARB, GLint, GLsizei, GLint const*) GLvoid
    WRAPPER04V(Uniform3fARB, GLint, GLfloat, GLfloat, GLfloat) GLvoid
    WRAPPER03V(Uniform3fvARB, GLint, GLsizei, GLfloat const*) GLvoid
    WRAPPER04V(Uniform3iARB, GLint, GLint, GLint, GLint) GLvoid
    WRAPPER03V(Uniform3ivARB, GLint, GLsizei, GLint const*) GLvoid
...
// ]-------------------------------------------------------------------------------
        ...
        GLvoid WRAPPER01V(LoadTransposeMatrixdARB, GLdouble const*) GLvoid
    WRAPPER01V(LoadTransposeMatrixfARB, GLfloat const*) GLvoid
    WRAPPER01V(MultTransposeMatrixdARB, GLdouble const*) GLvoid
    WRAPPER01V(MultTransposeMatrixfARB, GLfloat const*)
...
// ]-----------------------------------------------------------------------------------
        ...
        GLvoid WRAPPER01V(VertexBlendARB, GLint) GLvoid
    WRAPPER02V(WeightbvARB, GLint, GLbyte const*) GLvoid
    WRAPPER02V(WeightdvARB, GLint, GLdouble const*) GLvoid
    WRAPPER02V(WeightfvARB, GLint, GLfloat const*) GLvoid
    WRAPPER02V(WeightivARB, GLint, GLint const*) GLvoid
    WRAPPER04V(WeightPointerARB, GLint, GLenum, GLsizei, GLvoid const*) GLvoid
    WRAPPER02V(WeightsvARB, GLint, GLshort const*) GLvoid
    WRAPPER02V(WeightubvARB, GLint, GLubyte const*) GLvoid
    WRAPPER02V(WeightuivARB, GLint, GLuint const*) GLvoid
    WRAPPER02V(WeightusvARB, GLint, GLushort const*)
...
// ]---------------------------------------------------------------------------------
        ...
        GLvoid WRAPPER02V(BindProgramARB, GLenum, GLuint) GLvoid
    WRAPPER02V(DeleteProgramsARB, GLsizei, GLuint const*) GLvoid
    WRAPPER01V(DisableVertexAttribArrayARB, GLuint) GLvoid
    WRAPPER01V(EnableVertexAttribArrayARB, GLuint) GLvoid
    WRAPPER02V(GenProgramsARB, GLsizei, GLuint*) GLvoid
    WRAPPER03V(GetProgramEnvParameterdvARB, GLenum, GLuint, GLdouble*) GLvoid
    WRAPPER03V(GetProgramEnvParameterfvARB, GLenum, GLuint, GLfloat*) GLvoid
    WRAPPER03V(GetProgramivARB, GLenum, GLenum, GLint*) GLvoid
    WRAPPER03V(GetProgramLocalParameterdvARB, GLenum, GLuint, GLdouble*) GLvoid
    WRAPPER03V(GetProgramLocalParameterfvARB, GLenum, GLuint, GLfloat*) GLvoid
    WRAPPER03V(GetProgramStringARB, GLenum, GLenum, GLvoid*) GLvoid
    WRAPPER03V(GetVertexAttribdvARB, GLuint, GLenum, GLdouble*) GLvoid
    WRAPPER03V(GetVertexAttribfvARB, GLuint, GLenum, GLfloat*) GLvoid
    ...
    WRAPPER02V(VertexAttrib1fARB, GLuint, GLfloat) GLvoid
    WRAPPER02V(VertexAttrib1fvARB, GLuint, GLfloat const*) GLvoid
    WRAPPER02V(VertexAttrib1sARB, GLuint, GLshort) GLvoid
    WRAPPER02V(VertexAttrib1svARB, GLuint, GLshort const*) GLvoid
    WRAPPER03V(VertexAttrib2dARB, GLuint, GLdouble, GLdouble) GLvoid
    WRAPPER02V(VertexAttrib2dvARB, GLuint, GLdouble const*) GLvoid
    WRAPPER03V(VertexAttrib2fARB, GLuint, GLfloat, GLfloat) GLvoid
    WRAPPER02V(VertexAttrib2fvARB, GLuint, GLfloat const*) GLvoid
    WRAPPER03V(VertexAttrib2sARB, GLuint, GLshort, GLshort) GLvoid
    WRAPPER02V(VertexAttrib2svARB, GLuint, GLshort const*) GLvoid
    WRAPPER04V(VertexAttrib3dARB, GLuint, GLdouble, GLdouble, GLdouble) GLvoid
    WRAPPER02V(VertexAttrib3dvARB, GLuint, GLdouble const*) GLvoid
    WRAPPER04V(VertexAttrib3fARB, GLuint, GLfloat, GLfloat, GLfloat) GLvoid
    WRAPPER02V(VertexAttrib3fvARB, GLuint, GLfloat const*) GLvoid
...
// ]-------------------------------------------------------------------------------------
        ...
        GLvoid WRAPPER02V(WindowPos2dARB, GLdouble, GLdouble) GLvoid
    WRAPPER01V(WindowPos2dvARB, GLdouble const*) GLvoid
    WRAPPER02V(WindowPos2fARB, GLfloat, GLfloat) GLvoid
    WRAPPER01V(WindowPos2fvARB, GLfloat const*) GLvoid
    WRAPPER02V(WindowPos2iARB, GLint, GLint) GLvoid
    WRAPPER01V(WindowPos2ivARB, GLint const*) GLvoid
    WRAPPER02V(WindowPos2sARB, GLshort, GLshort) GLvoid
    WRAPPER01V(WindowPos2svARB, GLshort const*) GLvoid
    WRAPPER03V(WindowPos3dARB, GLdouble, GLdouble, GLdouble) GLvoid
    WRAPPER01V(WindowPos3dvARB, GLdouble const*) GLvoid
    WRAPPER03V(WindowPos3fARB, GLfloat, GLfloat, GLfloat) GLvoid
    WRAPPER01V(WindowPos3fvARB, GLfloat const*) GLvoid
    WRAPPER03V(WindowPos3iARB, GLint, GLint, GLint) GLvoid
    WRAPPER01V(WindowPos3ivARB, GLint const*) GLvoid
    WRAPPER03V(WindowPos3sARB, GLshort, GLshort, GLshort) GLvoid
    WRAPPER01V(WindowPos3svARB, GLshort const*)
...
// ]----------------------------------------------------------------------------------
            ...
            GLvoid WRAPPER02V(DrawElementArrayATI, GLenum, GLsizei) GLvoid
    WRAPPER04V(DrawRangeElementArrayATI, GLenum, GLuint, GLuint, GLsizei) GLvoid
    WRAPPER02V(ElementPointerATI, GLenum, GLvoid const*)
...
// ]---------------------------------------------------------------------------------
    ...
    WRAPPER02V(GetTexBumpParameterivATI, GLenum, GLint*) GLvoid
    WRAPPER02V(TexBumpParameterfvATI, GLenum, GLfloat const*) GLvoid
    WRAPPER02V(TexBumpParameterivATI, GLenum, GLint const*)
...
// ]--------------------------------------------------------------------------------
    ...
    WRAPPER03V(SampleMapATI, GLuint, GLuint, GLenum) GLvoid
    WRAPPER02V(SetFragmentShaderConstantATI, GLuint, GLfloat const*)
...
// ]------------------------------------------------------------------------------
        ...
        GLvoid* WRAPPER01R(MapObjectBufferATI, GLuint) GLvoid
    WRAPPER01V(UnmapObjectBufferATI, GLuint)
...
// ]-----------------------------------------------------------------------------------
        ...
        GLvoid WRAPPER02V(PNTrianglesfATI, GLenum, GLfloat) GLvoid
    WRAPPER02V(PNTrianglesiATI, GLenum, GLint)
...
// ]-------------------------------------------------------------------------------
        ...
        GLvoid
    WRAPPER04V(StencilFuncSeparateATI, GLenum, GLenum, GLint, GLuint) GLvoid
    WRAPPER04V(StencilOpSeparateATI, GLenum, GLenum, GLenum, GLenum)
...
// ]----------------------------------------------------------------------------
        ...
        GLvoid
    WRAPPER06V(ArrayObjectATI, GLenum, GLint, GLenum, GLsizei, GLuint, GLuint)
        GLvoid WRAPPER01V(FreeObjectBufferATI, GLuint) GLvoid
    WRAPPER03V(GetArrayObjectfvATI, GLenum, GLenum, GLfloat*) GLvoid
    WRAPPER03V(GetArrayObjectivATI, GLenum, GLenum, GLint*) GLvoid
    WRAPPER03V(GetObjectBufferfvATI, GLuint, GLenum, GLfloat*) GLvoid
    WRAPPER03V(GetObjectBufferivATI, GLuint, GLenum, GLint*) GLvoid
    WRAPPER03V(GetVariantArrayObjectfvATI, GLuint, GLenum, GLfloat*) GLvoid
    WRAPPER03V(GetVariantArrayObjectivATI, GLuint, GLenum, GLint*) GLboolean
...
// ]---------------------------------------------------------------------------------
        ...
        GLvoid WRAPPER01V(ClientActiveVertexStreamATI, GLenum) GLvoid
    WRAPPER04V(NormalStream3bATI, GLenum, GLbyte, GLbyte, GLbyte) GLvoid
    WRAPPER02V(NormalStream3bvATI, GLenum, GLbyte const*) GLvoid
    WRAPPER04V(NormalStream3dATI, GLenum, GLdouble, GLdouble, GLdouble) GLvoid
    WRAPPER02V(NormalStream3dvATI, GLenum, GLdouble const*) GLvoid
    WRAPPER04V(NormalStream3fATI, GLenum, GLfloat, GLfloat, GLfloat) GLvoid
    WRAPPER02V(NormalStream3fvATI, GLenum, GLfloat const*) GLvoid
    WRAPPER04V(NormalStream3iATI, GLenum, GLint, GLint, GLint) GLvoid
    WRAPPER02V(NormalStream3ivATI, GLenum, GLint const*) GLvoid
    WRAPPER04V(NormalStream3sATI, GLenum, GLshort, GLshort, GLshort) GLvoid
    WRAPPER02V(NormalStream3svATI, GLenum, GLshort const*) GLvoid
    WRAPPER02V(VertexBlendEnvfATI, GLenum, GLfloat) GLvoid
    WRAPPER02V(VertexBlendEnviATI, GLenum, GLint) GLvoid
    WRAPPER02V(VertexStream1dATI, GLenum, GLdouble) GLvoid
    WRAPPER02V(VertexStream1dvATI, GLenum, GLdouble const*) GLvoid
    WRAPPER02V(VertexStream1fATI, GLenum, GLfloat) GLvoid
    WRAPPER02V(VertexStream1fvATI, GLenum, GLfloat const*) GLvoid
    WRAPPER02V(VertexStream1iATI, GLenum, GLint) GLvoid
    WRAPPER02V(VertexStream1ivATI, GLenum, GLint const*) GLvoid
    WRAPPER02V(VertexStream1sATI, GLenum, GLshort) GLvoid
    WRAPPER02V(VertexStream1svATI, GLenum, GLshort const*) GLvoid
    WRAPPER03V(VertexStream2dATI, GLenum, GLdouble, GLdouble) GLvoid
    WRAPPER02V(VertexStream2dvATI, GLenum, GLdouble const*) GLvoid
    WRAPPER03V(VertexStream2fATI, GLenum, GLfloat, GLfloat) GLvoid
    WRAPPER02V(VertexStream2fvATI, GLenum, GLfloat const*) GLvoid
    WRAPPER03V(VertexStream2iATI, GLenum, GLint, GLint) GLvoid
    WRAPPER02V(VertexStream2ivATI, GLenum, GLint const*) GLvoid
    WRAPPER03V(VertexStream2sATI, GLenum, GLshort, GLshort) GLvoid
    WRAPPER02V(VertexStream2svATI, GLenum, GLshort const*) GLvoid
    WRAPPER04V(VertexStream3dATI, GLenum, GLdouble, GLdouble, GLdouble) GLvoid
    WRAPPER02V(VertexStream3dvATI, GLenum, GLdouble const*) GLvoid
    WRAPPER04V(VertexStream3fATI, GLenum, GLfloat, GLfloat, GLfloat) GLvoid
    WRAPPER02V(VertexStream3fvATI, GLenum, GLfloat const*) GLvoid
    WRAPPER04V(VertexStream3iATI, GLenum, GLint, GLint, GLint) GLvoid
...
// ]---------------------------------------------------------------------------------
    ...
    //   GLvoid            WRAPPER06V(ColorSubTableEXT, GLenum, GLsizei,
    //   GLsizei, GLenum, GLenum, GLvoid const *)
    GLvoid
    WRAPPER05V(CopyColorSubTableEXT, GLenum, GLsizei, GLint, GLint, GLsizei)
...
// ]--------------------------------------------------------------------------
        ...
        GLvoid WRAPPER02V(LockArraysEXT, GLint, GLsizei) GLvoid
    WRAPPER00V(UnlockArraysEXT)
...
// ]-------------------------------------------------------------------------------
        ...
        GLvoid WRAPPER03V(Binormal3bEXT, GLbyte, GLbyte, GLbyte) GLvoid
    WRAPPER01V(Binormal3bvEXT, GLbyte const*) GLvoid
    WRAPPER03V(Binormal3dEXT, GLdouble, GLdouble, GLdouble) GLvoid
    WRAPPER01V(Binormal3dvEXT, GLdouble const*) GLvoid
    WRAPPER03V(Binormal3fEXT, GLfloat, GLfloat, GLfloat) GLvoid
    WRAPPER01V(Binormal3fvEXT, GLfloat const*) GLvoid
    WRAPPER03V(Binormal3iEXT, GLint, GLint, GLint) GLvoid
    WRAPPER01V(Binormal3ivEXT, GLint const*) GLvoid
    WRAPPER03V(Binormal3sEXT, GLshort, GLshort, GLshort) GLvoid
    WRAPPER01V(Binormal3svEXT, GLshort const*) GLvoid
    WRAPPER03V(BinormalPointerEXT, GLenum, GLsizei, GLvoid const*) GLvoid
    WRAPPER03V(Tangent3bEXT, GLbyte, GLbyte, GLbyte) GLvoid
    WRAPPER01V(Tangent3bvEXT, GLbyte const*) GLvoid
    WRAPPER03V(Tangent3dEXT, GLdouble, GLdouble, GLdouble) GLvoid
    WRAPPER01V(Tangent3dvEXT, GLdouble const*) GLvoid
    WRAPPER03V(Tangent3fEXT, GLfloat, GLfloat, GLfloat) GLvoid
    WRAPPER01V(Tangent3fvEXT, GLfloat const*) GLvoid
    WRAPPER03V(Tangent3iEXT, GLint, GLint, GLint) GLvoid
    WRAPPER01V(Tangent3ivEXT, GLint const*) GLvoid
    WRAPPER03V(Tangent3sEXT, GLshort, GLshort, GLshort) GLvoid
    WRAPPER01V(Tangent3svEXT, GLshort const*) GLvoid
    WRAPPER03V(TangentPointerEXT, GLenum, GLsizei, GLvoid const*)
...
// ]------------------------------------------------------------------------------------
        ...
        GLvoid WRAPPER02V(CullParameterdvEXT, GLenum, GLdouble*) GLvoid
    WRAPPER02V(CullParameterfvEXT, GLenum, GLfloat*)
...
// ]--------------------------------------------------------------------------------------
                ...
                GLvoid WRAPPER01V(FogCoorddEXT, GLdouble) GLvoid
    WRAPPER01V(FogCoorddvEXT, GLdouble const*) GLvoid
    WRAPPER01V(FogCoordfEXT, GLfloat) GLvoid
    WRAPPER01V(FogCoordfvEXT, GLfloat const*) GLvoid
    WRAPPER03V(FogCoordPointerEXT, GLenum, GLsizei, GLvoid const*)
...
// ]-----------------------------------------------------------------------------
        ...
        GLvoid WRAPPER02V(BindFramebufferEXT, GLenum, GLuint) GLvoid
    WRAPPER02V(BindRenderbufferEXT, GLenum, GLuint) GLenum
    ...
    WRAPPER01R(IsRenderbufferEXT, GLuint) GLvoid
    WRAPPER04V(RenderbufferStorageEXT, GLenum, GLenum, GLsizei, GLsizei)
...
// ]--------------------------------------------------------------------------------------
    ...
    WRAPPER03V(GetMinmaxParameterfvEXT, GLenum, GLenum, GLfloat*) GLvoid
    WRAPPER03V(GetMinmaxParameterivEXT, GLenum, GLenum, GLint*) GLvoid
    WRAPPER04V(HistogramEXT, GLenum, GLsizei, GLenum, GLboolean) GLvoid
    WRAPPER03V(MinmaxEXT, GLenum, GLenum, GLboolean) GLvoid
    WRAPPER01V(ResetHistogramEXT, GLenum) GLvoid
    WRAPPER01V(ResetMinmaxEXT, GLenum)
...
// ]----------------------------------------------------------------------------------
                ...
                GLvoid WRAPPER01V(ApplyTextureEXT, GLenum) GLvoid
    WRAPPER01V(TextureLightEXT, GLenum) GLvoid
    WRAPPER02V(TextureMaterialEXT, GLenum, GLenum)
...
// ]------------------------------------------------------------------------------------
        ...
        GLvoid WRAPPER02V(SampleMaskEXT, GLclampf, GLboolean) GLvoid
    WRAPPER01V(SamplePatternEXT, GLenum)
...
// ]-------------------------------------------------------------------------------
    ...
    WRAPPER03V(GetColorTableParameterivEXT, GLenum, GLenum, GLint*)
...
// ]-------------------------------------------------------------------------------
        ...
        GLvoid WRAPPER02V(PointParameterfEXT, GLenum, GLfloat) GLvoid
    WRAPPER02V(PointParameterfvEXT, GLenum, GLfloat const*)
...
// ]--------------------------------------------------------------------------------
            ...
            GLvoid
    WRAPPER03V(SecondaryColor3bEXT, GLbyte, GLbyte, GLbyte) GLvoid
    WRAPPER01V(SecondaryColor3bvEXT, GLbyte const*) GLvoid
    WRAPPER03V(SecondaryColor3dEXT, GLdouble, GLdouble, GLdouble) GLvoid
    WRAPPER01V(SecondaryColor3dvEXT, GLdouble const*) GLvoid
    WRAPPER03V(SecondaryColor3fEXT, GLfloat, GLfloat, GLfloat) GLvoid
    WRAPPER01V(SecondaryColor3fvEXT, GLfloat const*) GLvoid
    WRAPPER03V(SecondaryColor3iEXT, GLint, GLint, GLint) GLvoid
    WRAPPER01V(SecondaryColor3ivEXT, GLint const*) GLvoid
    WRAPPER03V(SecondaryColor3sEXT, GLshort, GLshort, GLshort) GLvoid
    WRAPPER01V(SecondaryColor3svEXT, GLshort const*) GLvoid
    WRAPPER03V(SecondaryColor3ubEXT, GLubyte, GLubyte, GLubyte) GLvoid
    WRAPPER01V(SecondaryColor3ubvEXT, GLubyte const*) GLvoid
    WRAPPER03V(SecondaryColor3uiEXT, GLuint, GLuint, GLuint) GLvoid
    WRAPPER01V(SecondaryColor3uivEXT, GLuint const*) GLvoid
    WRAPPER03V(SecondaryColor3usEXT, GLushort, GLushort, GLushort) GLvoid
    WRAPPER01V(SecondaryColor3usvEXT, GLushort const*) GLvoid
    WRAPPER04V(SecondaryColorPointerEXT, GLint, GLenum, GLsizei, GLvoid const*)
...
// ]---------------------------------------------------------------------------------
    ...
    WRAPPER03V(PrioritizeTexturesEXT, GLsizei, GLuint const*, GLclampf const*)
...
// ]-----------------------------------------------------------------------------------
            ...
            GLvoid WRAPPER01V(ArrayElementEXT, GLint) GLvoid
    WRAPPER05V(ColorPointerEXT, GLint, GLenum, GLsizei, GLsizei, GLvoid const*)
        GLvoid WRAPPER03V(DrawArraysEXT, GLenum, GLint, GLsizei) GLvoid
    WRAPPER03V(EdgeFlagPointerEXT, GLsizei, GLsizei, GLboolean const*) GLvoid
    WRAPPER02V(GetPointervEXT, GLenum, GLvoid**) GLvoid
...
// ]----------------------------------------------------------------------------------
        ...
        GLvoid WRAPPER00V(BeginVertexShaderEXT) GLuint
    WRAPPER02R(BindLightParameterEXT, GLenum, GLenum) GLuint
    WRAPPER02R(BindMaterialParameterEXT, GLenum, GLenum) GLuint
    WRAPPER01R(BindParameterEXT, GLenum) GLuint
    WRAPPER03R(BindTexGenParameterEXT, GLenum, GLenum, GLenum) GLuint
    WRAPPER02R(BindTextureUnitParameterEXT, GLenum, GLenum) GLvoid
    WRAPPER01V(BindVertexShaderEXT, GLuint) GLvoid
    WRAPPER01V(DeleteVertexShaderEXT, GLuint) GLvoid
    WRAPPER01V(DisableVariantClientStateEXT, GLuint) GLvoid
    WRAPPER01V(EnableVariantClientStateEXT, GLuint) GLvoid
    WRAPPER00V(EndVertexShaderEXT) GLvoid
    WRAPPER03V(ExtractComponentEXT, GLuint, GLuint, GLuint) GLuint
    WRAPPER04R(GenSymbolsEXT, GLenum, GLenum, GLenum, GLuint) GLuint
    WRAPPER01R(GenVertexShadersEXT, GLuint) GLvoid
    WRAPPER03V(GetInvariantBooleanvEXT, GLuint, GLenum, GLboolean*) GLvoid
    WRAPPER03V(GetInvariantFloatvEXT, GLuint, GLenum, GLfloat*) GLvoid
    WRAPPER03V(GetInvariantIntegervEXT, GLuint, GLenum, GLint*) GLvoid
    WRAPPER03V(GetLocalConstantBooleanvEXT, GLuint, GLenum, GLboolean*) GLvoid
    WRAPPER03V(GetLocalConstantFloatvEXT, GLuint, GLenum, GLfloat*) GLvoid
    WRAPPER03V(GetLocalConstantIntegervEXT, GLuint, GLenum, GLint*) GLvoid
    WRAPPER03V(GetVariantBooleanvEXT, GLuint, GLenum, GLboolean*) GLvoid
    WRAPPER03V(GetVariantFloatvEXT, GLuint, GLenum, GLfloat*) GLvoid
    WRAPPER03V(GetVariantIntegervEXT, GLuint, GLenum, GLint*) GLvoid
    WRAPPER03V(GetVariantPointervEXT, GLuint, GLenum, GLvoid**) GLvoid
    WRAPPER03V(InsertComponentEXT, GLuint, GLuint, GLuint) GLboolean
    WRAPPER02R(IsVariantEnabledEXT, GLuint, GLenum) GLvoid
    WRAPPER03V(SetInvariantEXT, GLuint, GLenum, GLvoid const*) GLvoid
    WRAPPER03V(SetLocalConstantEXT, GLuint, GLenum, GLvoid const*) GLvoid
    WRAPPER03V(ShaderOp1EXT, GLenum, GLuint, GLuint) GLvoid
    WRAPPER04V(ShaderOp2EXT, GLenum, GLuint, GLuint, GLuint) GLvoid
    WRAPPER05V(ShaderOp3EXT, GLenum, GLuint, GLuint, GLuint, GLuint) GLvoid
    WRAPPER06V(SwizzleEXT, GLuint, GLuint, GLenum, GLenum, GLenum, GLenum)
        GLvoid WRAPPER02V(VariantbvEXT, GLuint, GLbyte const*) GLvoid
    WRAPPER02V(VariantdvEXT, GLuint, GLdouble const*) GLvoid
    WRAPPER02V(VariantfvEXT, GLuint, GLfloat const*) GLvoid
    WRAPPER02V(VariantivEXT, GLuint, GLint const*) GLvoid
    WRAPPER04V(VariantPointerEXT, GLuint, GLenum, GLuint, GLvoid const*) GLvoid
    WRAPPER02V(VariantsvEXT, GLuint, GLshort const*) GLvoid
    WRAPPER02V(VariantubvEXT, GLuint, GLubyte const*) GLvoid
    WRAPPER02V(VariantuivEXT, GLuint, GLuint const*) GLvoid
    WRAPPER02V(VariantusvEXT, GLuint, GLushort const*) GLvoid
    WRAPPER06V(WriteMaskEXT, GLuint, GLuint, GLenum, GLenum, GLenum, GLenum)
...
// ]-------------------------------------------------------------------------------
        ...
        GLvoid WRAPPER01V(VertexWeightfEXT, GLfloat) GLvoid
    WRAPPER01V(VertexWeightfvEXT, GLfloat const*) GLvoid
    WRAPPER04V(VertexWeightPointerEXT, GLsizei, GLenum, GLsizei, GLvoid const*)
...
// ]------------------------------------------------------------------------------
            ...
            GLvoid
    WRAPPER03V(ColorPointervINTEL, GLint, GLenum, GLvoid const**) GLvoid
    WRAPPER02V(NormalPointervINTEL, GLenum, GLvoid const**) GLvoid
    WRAPPER03V(TexCoordPointervINTEL, GLint, GLenum, GLvoid const**) GLvoid
    WRAPPER03V(VertexPointervINTEL, GLint, GLenum, GLvoid const**)
...
// ]------------------------------------------------------------------------------------
            ...
            GLvoid WRAPPER02V(WindowPos2dMESA, GLdouble, GLdouble) GLvoid
    WRAPPER01V(WindowPos2dvMESA, GLdouble const*) GLvoid
    WRAPPER02V(WindowPos2fMESA, GLfloat, GLfloat) GLvoid
    WRAPPER01V(WindowPos2fvMESA, GLfloat const*) GLvoid
    WRAPPER02V(WindowPos2iMESA, GLint, GLint) GLvoid
    WRAPPER01V(WindowPos2ivMESA, GLint const*) GLvoid
    WRAPPER02V(WindowPos2sMESA, GLshort, GLshort) GLvoid
    WRAPPER01V(WindowPos2svMESA, GLshort const*) GLvoid
    WRAPPER03V(WindowPos3dMESA, GLdouble, GLdouble, GLdouble) GLvoid
    WRAPPER01V(WindowPos3dvMESA, GLdouble const*) GLvoid
    WRAPPER03V(WindowPos3fMESA, GLfloat, GLfloat, GLfloat) GLvoid
    WRAPPER01V(WindowPos3fvMESA, GLfloat const*) GLvoid
    WRAPPER03V(WindowPos3iMESA, GLint, GLint, GLint) GLvoid
    WRAPPER01V(WindowPos3ivMESA, GLint const*) GLvoid
    WRAPPER03V(WindowPos3sMESA, GLshort, GLshort, GLshort) GLvoid
    WRAPPER01V(WindowPos3svMESA, GLshort const*) GLvoid
    WRAPPER04V(WindowPos4dMESA, GLdouble, GLdouble, GLdouble, GLdouble) GLvoid
    WRAPPER01V(WindowPos4dvMESA, GLdouble const*) GLvoid
    WRAPPER04V(WindowPos4fMESA, GLfloat, GLfloat, GLfloat, GLfloat) GLvoid
    WRAPPER01V(WindowPos4fvMESA, GLfloat const*) GLvoid
    WRAPPER04V(WindowPos4iMESA, GLint, GLint, GLint, GLint) GLvoid
    WRAPPER01V(WindowPos4ivMESA, GLint const*) GLvoid
    WRAPPER04V(WindowPos4sMESA, GLshort, GLshort, GLshort, GLshort) GLvoid
    WRAPPER01V(WindowPos4svMESA, GLshort const*)
...
// ]-------------------------------------------------------------------------------------------
        ...
        GLvoid WRAPPER02V(DeleteFencesNV, GLsizei, GLuint const*) GLvoid
    WRAPPER01V(FinishFenceNV, GLuint) GLvoid
    WRAPPER02V(GenFencesNV, GLsizei, GLuint*) GLvoid
    WRAPPER03V(GetFenceivNV, GLuint, GLenum, GLint*) GLboolean
    WRAPPER01R(IsFenceNV, GLuint) GLvoid
    WRAPPER02V(SetFenceNV, GLuint, GLenum) GLboolean
    WRAPPER01R(TestFenceNV, GLuint)
...
// ]--------------------------------------------------------------------------------------
        ...
        GLvoid WRAPPER03V(Color3hNV, GLhalfNV, GLhalfNV, GLhalfNV) GLvoid
    WRAPPER01V(Color3hvNV, GLhalfNV const*) GLvoid
    WRAPPER04V(Color4hNV, GLhalfNV, GLhalfNV, GLhalfNV, GLhalfNV) GLvoid
    WRAPPER01V(Color4hvNV, GLhalfNV const*) GLvoid
    WRAPPER01V(FogCoordhNV, GLhalfNV) GLvoid
    WRAPPER01V(FogCoordhvNV, GLhalfNV const*) GLvoid
    WRAPPER02V(MultiTexCoord1hNV, GLenum, GLhalfNV) GLvoid
    WRAPPER02V(MultiTexCoord1hvNV, GLenum, GLhalfNV const*) GLvoid
    WRAPPER03V(MultiTexCoord2hNV, GLenum, GLhalfNV, GLhalfNV) GLvoid
    ...
    WRAPPER01V(Normal3hvNV, GLhalfNV const*) GLvoid
    WRAPPER03V(SecondaryColor3hNV, GLhalfNV, GLhalfNV, GLhalfNV) GLvoid
    WRAPPER01V(SecondaryColor3hvNV, GLhalfNV const*) GLvoid
    WRAPPER01V(TexCoord1hNV, GLhalfNV) GLvoid
    WRAPPER01V(TexCoord1hvNV, GLhalfNV const*) GLvoid
    WRAPPER02V(TexCoord2hNV, GLhalfNV, GLhalfNV) GLvoid
    WRAPPER01V(TexCoord2hvNV, GLhalfNV const*) GLvoid
    WRAPPER03V(TexCoord3hNV, GLhalfNV, GLhalfNV, GLhalfNV) GLvoid
    WRAPPER01V(TexCoord3hvNV, GLhalfNV const*) GLvoid
    WRAPPER04V(TexCoord4hNV, GLhalfNV, GLhalfNV, GLhalfNV, GLhalfNV) GLvoid
    WRAPPER01V(TexCoord4hvNV, GLhalfNV const*) GLvoid
    WRAPPER02V(Vertex2hNV, GLhalfNV, GLhalfNV) GLvoid
    WRAPPER01V(Vertex2hvNV, GLhalfNV const*) GLvoid
    WRAPPER03V(Vertex3hNV, GLhalfNV, GLhalfNV, GLhalfNV) GLvoid
    WRAPPER01V(Vertex3hvNV, GLhalfNV const*) GLvoid
    WRAPPER04V(Vertex4hNV, GLhalfNV, GLhalfNV, GLhalfNV, GLhalfNV) GLvoid
    WRAPPER01V(Vertex4hvNV, GLhalfNV const*) GLvoid
    WRAPPER02V(VertexAttrib1hNV, GLuint, GLhalfNV) GLvoid
    WRAPPER02V(VertexAttrib1hvNV, GLuint, GLhalfNV const*) GLvoid
    ...
    WRAPPER03V(VertexAttribs4hvNV, GLuint, GLsizei, GLhalfNV const*) GLvoid
    WRAPPER01V(VertexWeighthNV, GLhalfNV) GLvoid
    WRAPPER01V(VertexWeighthvNV, GLhalfNV const*)
...
// ]---------------------------------------------------------------------------------
        ...
        GLvoid WRAPPER01V(BeginOcclusionQueryNV, GLuint) GLvoid
    WRAPPER02V(DeleteOcclusionQueriesNV, GLsizei, GLuint const*) GLvoid
    WRAPPER00V(EndOcclusionQueryNV) GLvoid
    WRAPPER02V(GenOcclusionQueriesNV, GLsizei, GLuint*) GLvoid
    WRAPPER03V(GetOcclusionQueryivNV, GLuint, GLenum, GLint*) GLvoid
    WRAPPER03V(GetOcclusionQueryuivNV, GLuint, GLenum, GLuint*) GLboolean
    WRAPPER01R(IsOcclusionQueryNV, GLuint)
...
// ]--------------------------------------------------------------------------------
        ...
        GLvoid WRAPPER01V(FlushPixelDataRangeNV, GLenum) GLvoid
    WRAPPER03V(PixelDataRangeNV, GLenum, GLsizei, GLvoid*)
...
// ]------------------------------------------------------------------------------------
        ...
        GLvoid WRAPPER02V(PointParameteriNV, GLenum, GLint) GLvoid
    WRAPPER02V(PointParameterivNV, GLenum, GLint const*)
...
// ]-------------------------------------------------------------------------------
        ...
        GLvoid WRAPPER01V(PrimitiveRestartIndexNV, GLuint) GLvoid
    WRAPPER00V(PrimitiveRestartNV)
...
// ]------------------------------------------------------------------------------
            ...
            GLvoid WRAPPER00V(FlushVertexArrayRangeNV) GLvoid
    WRAPPER02V(VertexArrayRangeNV, GLsizei, GLvoid const*)
...
// ]----------------------------------------------------------------------------------
        ...
        GLboolean
    WRAPPER03R(AreProgramsResidentNV, GLsizei, GLuint const*, GLboolean*) GLvoid
    WRAPPER02V(BindProgramNV, GLenum, GLuint) GLvoid
    ...
    WRAPPER03V(GetVertexAttribdvNV, GLuint, GLenum, GLdouble*) GLvoid
    WRAPPER03V(GetVertexAttribfvNV, GLuint, GLenum, GLfloat*) GLvoid
    WRAPPER03V(GetVertexAttribivNV, GLuint, GLenum, GLint*) GLvoid
    WRAPPER03V(GetVertexAttribPointervNV, GLuint, GLenum, GLvoid**) GLboolean
    ...
    WRAPPER02V(VertexAttrib1dvNV, GLuint, GLdouble const*) GLvoid
    WRAPPER02V(VertexAttrib1fNV, GLuint, GLfloat) GLvoid
    WRAPPER02V(VertexAttrib1fvNV, GLuint, GLfloat const*) GLvoid
    WRAPPER02V(VertexAttrib1sNV, GLuint, GLshort) GLvoid
    WRAPPER02V(VertexAttrib1svNV, GLuint, GLshort const*) GLvoid
    WRAPPER03V(VertexAttrib2dNV, GLuint, GLdouble, GLdouble) GLvoid
    WRAPPER02V(VertexAttrib2dvNV, GLuint, GLdouble const*) GLvoid
    WRAPPER03V(VertexAttrib2fNV, GLuint, GLfloat, GLfloat) GLvoid
    WRAPPER02V(VertexAttrib2fvNV, GLuint, GLfloat const*) GLvoid
    WRAPPER03V(VertexAttrib2sNV, GLuint, GLshort, GLshort) GLvoid
    WRAPPER02V(VertexAttrib2svNV, GLuint, GLshort const*) GLvoid
    WRAPPER04V(VertexAttrib3dNV, GLuint, GLdouble, GLdouble, GLdouble) GLvoid
    WRAPPER02V(VertexAttrib3dvNV, GLuint, GLdouble const*) GLvoid
    ...
    WRAPPER03V(VertexAttribs1svNV, GLuint, GLsizei, GLshort const*) GLvoid
    WRAPPER03V(VertexAttribs2dvNV, GLuint, GLsizei, GLdouble const*) GLvoid
    WRAPPER03V(VertexAttribs2fvNV, GLuint, GLsizei, GLfloat const*) GLvoid
    WRAPPER03V(VertexAttribs2svNV, GLuint, GLsizei, GLshort const*) GLvoid
    WRAPPER03V(VertexAttribs3dvNV, GLuint, GLsizei, GLdouble const*) GLvoid
    WRAPPER03V(VertexAttribs3fvNV, GLuint, GLsizei, GLfloat const*) GLvoid
    WRAPPER03V(VertexAttribs3svNV, GLuint, GLsizei, GLshort const*) GLvoid
    WRAPPER03V(VertexAttribs4dvNV, GLuint, GLsizei, GLdouble const*) GLvoid
    WRAPPER03V(VertexAttribs4fvNV, GLuint, GLsizei, GLfloat const*) GLvoid
    WRAPPER03V(VertexAttribs4svNV, GLuint, GLsizei, GLshort const*) GLvoid
    WRAPPER03V(VertexAttribs4ubvNV, GLuint, GLsizei, GLubyte const*)
...
// ]-----------------------------------------------------------------------------
        ...
        GLvoid WRAPPER01V(BeginConditionalRenderNVX, GLuint) GLvoid
    WRAPPER00V(EndConditionalRenderNVX)
...
// ]------------------------------------------------------------------------------------
    ...
    WRAPPER03V(GetColorTableParameterivSGI, GLenum, GLenum, GLint*) GLvoid
    WRAPPER04V(GetColorTableSGI, GLenum, GLenum, GLenum, GLvoid*)
...
// ]--------------------------------------------------------------------------------
        ...
        GLvoid
    WRAPPER03V(DetailTexFuncSGIS, GLenum, GLsizei, GLfloat const*) GLvoid
    WRAPPER02V(GetDetailTexFuncSGIS, GLenum, GLfloat*)
...
// ]----------------------------------------------------------------------------------
        ...
        GLvoid WRAPPER02V(FogFuncSGIS, GLsizei, GLfloat const*) GLvoid
    WRAPPER01V(GetFogFuncSGIS, GLfloat*)
...
// ]-----------------------------------------------------------------------------------
        ...
        GLvoid WRAPPER02V(SampleMaskSGIS, GLclampf, GLboolean) GLvoid
    WRAPPER01V(SamplePatternSGIS, GLenum)
...
// ]---------------------------------------------------------------------------------
    ...
    WRAPPER02V(GetPixelTexGenParameterivSGIS, GLenum, GLint*) GLvoid
    WRAPPER02V(PixelTexGenParameterfSGIS, GLenum, GLfloat) GLvoid
    WRAPPER02V(PixelTexGenParameterfvSGIS, GLenum, GLfloat const*) GLvoid
    WRAPPER02V(PixelTexGenParameteriSGIS, GLenum, GLint) GLvoid
    WRAPPER02V(PixelTexGenParameterivSGIS, GLenum, GLint const*)
...
// ]------------------------------------------------------------------------------
        ...
        GLvoid WRAPPER02V(PointParameterfSGIS, GLenum, GLfloat) GLvoid
    WRAPPER02V(PointParameterfvSGIS, GLenum, GLfloat const*)
...
// ]-------------------------------------------------------------------------------
        ...
        GLvoid WRAPPER02V(GetSharpenTexFuncSGIS, GLenum, GLfloat*) GLvoid
    WRAPPER03V(SharpenTexFuncSGIS, GLenum, GLsizei, GLfloat const*)
...
// ]----------------------------------------------------------------------------
        ...
        GLvoid
    WRAPPER04V(TextureColorMaskSGIS, GLboolean, GLboolean, GLboolean, GLboolean)
...
// ]-------------------------------------------------------------------------------
        ...
        GLvoid WRAPPER03V(GetTexFilterFuncSGIS, GLenum, GLenum, GLfloat*) GLvoid
    WRAPPER04V(TexFilterFuncSGIS, GLenum, GLenum, GLsizei, GLfloat const*)
...
// ]-----------------------------------------------------------------------------------------
        ...
        GLvoid WRAPPER01V(AsyncMarkerSGIX, GLuint) GLvoid
    WRAPPER02V(DeleteAsyncMarkersSGIX, GLuint, GLsizei) GLint
    WRAPPER01R(FinishAsyncSGIX, GLuint*) GLuint
    WRAPPER01R(GenAsyncMarkersSGIX, GLsizei) GLboolean
    WRAPPER01R(IsAsyncMarkerSGIX, GLuint) GLint
    WRAPPER01R(PollAsyncSGIX, GLuint*)
...
// ]-----------------------------------------------------------------------------
            ...
            GLvoid WRAPPER02V(FragmentColorMaterialSGIX, GLenum, GLenum) GLvoid
    WRAPPER03V(FragmentLightfSGIX, GLenum, GLenum, GLfloat) GLvoid
    WRAPPER03V(FragmentLightfvSGIX, GLenum, GLenum, GLfloat const*) GLvoid
    WRAPPER03V(FragmentLightiSGIX, GLenum, GLenum, GLint) GLvoid
    WRAPPER03V(FragmentLightivSGIX, GLenum, GLenum, GLint const*) GLvoid
    WRAPPER02V(FragmentLightModelfSGIX, GLenum, GLfloat) GLvoid
    WRAPPER02V(FragmentLightModelfvSGIX, GLenum, GLfloat const*) GLvoid
    WRAPPER02V(FragmentLightModeliSGIX, GLenum, GLint) GLvoid
    WRAPPER02V(FragmentLightModelivSGIX, GLenum, GLint const*) GLvoid
    WRAPPER03V(FragmentMaterialfSGIX, GLenum, GLenum, GLfloat) GLvoid
    WRAPPER03V(FragmentMaterialfvSGIX, GLenum, GLenum, GLfloat const*) GLvoid
    WRAPPER03V(FragmentMaterialiSGIX, GLenum, GLenum, GLint) GLvoid
    WRAPPER03V(FragmentMaterialivSGIX, GLenum, GLenum, GLint const*) GLvoid
    WRAPPER03V(GetFragmentLightfvSGIX, GLenum, GLenum, GLfloat*) GLvoid
    WRAPPER03V(GetFragmentLightivSGIX, GLenum, GLenum, GLint*) GLvoid
    WRAPPER03V(GetFragmentMaterialfvSGIX, GLenum, GLenum, GLfloat*) GLvoid
    WRAPPER03V(GetFragmentMaterialivSGIX, GLenum, GLenum, GLint*) GLvoid
    WRAPPER02V(LightEnviSGIX, GLenum, GLint)
...
// ]-----------------------------------------------------------------------------------
                ...
                GLint WRAPPER00R(GetInstrumentsSGIX) GLvoid
    WRAPPER02V(InstrumentsBufferSGIX, GLsizei, GLint*) GLint
    WRAPPER01R(PollInstrumentsSGIX, GLint*) GLvoid
    WRAPPER01V(ReadInstrumentsSGIX, GLint) GLvoid
    WRAPPER00V(StartInstrumentsSGIX) GLvoid
    WRAPPER01V(StopInstrumentsSGIX, GLint)
...
// ]---------------------------------------------------------------------------------
        ...
        GLvoid
    WRAPPER03V(GetListParameterfvSGIX, GLuint, GLenum, GLfloat*) GLvoid
    WRAPPER03V(GetListParameterivSGIX, GLuint, GLenum, GLint*) GLvoid
    WRAPPER03V(ListParameterfSGIX, GLuint, GLenum, GLfloat) GLvoid
    WRAPPER03V(ListParameterfvSGIX, GLuint, GLenum, GLfloat const*) GLvoid
    WRAPPER03V(ListParameteriSGIX, GLuint, GLenum, GLint) GLvoid
    WRAPPER03V(ListParameterivSGIX, GLuint, GLenum, GLint const*)
...
// ]----------------------------------------------------------------------------------------
            ...
            GLvoid WRAPPER02V(SpriteParameterfSGIX, GLenum, GLfloat) GLvoid
    WRAPPER02V(SpriteParameterfvSGIX, GLenum, GLfloat const*) GLvoid
    WRAPPER02V(SpriteParameteriSGIX, GLenum, GLint) GLvoid
    WRAPPER02V(SpriteParameterivSGIX, GLenum, GLint const*)
...
// ]-----------------------------------------------------------------------------------
            ...
            GLvoid WRAPPER01V(GlobalAlphaFactorbSUN, GLbyte) GLvoid
    WRAPPER01V(GlobalAlphaFactordSUN, GLdouble) GLvoid
    WRAPPER01V(GlobalAlphaFactorfSUN, GLfloat) GLvoid
    WRAPPER01V(GlobalAlphaFactoriSUN, GLint) GLvoid
    WRAPPER01V(GlobalAlphaFactorsSUN, GLshort) GLvoid
    WRAPPER01V(GlobalAlphaFactorubSUN, GLubyte) GLvoid
    WRAPPER01V(GlobalAlphaFactoruiSUN, GLuint) GLvoid
    WRAPPER01V(GlobalAlphaFactorusSUN, GLushort)
...
// ]----------------------------------------------------------------------------------
            ...
            GLvoid
    WRAPPER03V(ReplacementCodePointerSUN, GLenum, GLsizei, GLvoid const**)
        GLvoid WRAPPER01V(ReplacementCodeubSUN, GLubyte) GLvoid
    WRAPPER01V(ReplacementCodeubvSUN, GLubyte const*) GLvoid
    WRAPPER01V(ReplacementCodeuiSUN, GLuint) GLvoid
    WRAPPER01V(ReplacementCodeuivSUN, GLuint const*) GLvoid
    WRAPPER01V(ReplacementCodeusSUN, GLushort) GLvoid
    WRAPPER01V(ReplacementCodeusvSUN, GLushort const*)
