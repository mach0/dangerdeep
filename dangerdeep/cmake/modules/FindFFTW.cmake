#
# based on
# https://github.com/egpbos/findFFTW/blob/master/FindFFTW.cmake which is 
# based on https://github.com/wjakob/layerlab/blob/master/cmake/FindFFTW.cmake
#
# Usage:
#   find_package(FFTW [REQUIRED] [QUIET] [COMPONENTS component ... ] )
#
# It sets the following variables:
#   FFTW_FOUND                  ... true if fftw is found on the system
#   FFTW_[component]_LIB_FOUND  ... true if the component is found
#   FFTW_LIBRARIES              ... full paths to all found fftw libraries
#   FFTW_[component]_LIB        ... full path to one of the component
#   FFTW_INCLUDE_DIRS           ... fftw include directory paths
#
# The following variables will be checked by the function
#   FFTW_USE_STATIC_LIBS        ... search static or shared libraries
#   FFTW_ROOT                   ... search path root
#
...
# When finding libraries, the correct lib suffix for 32, 32x, 64 bits is done
# via FIND_LIBRARY_USE_LIB64_PATHS boolean which is set on the root project.
# Extra path suffixes are to be added via PATH_SUFFIX but none needed.
